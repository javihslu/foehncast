...
def _summary_report_dir(summary_location: str) -> str:
    return (
...
def runtime_release_summary_history_paths() -> list[str | Path]:
    ...
    return history_json_paths(
        _summary_report_dir(summary_location), "runtime-release-*.json"
    )
...
def _write_runtime_release_history(
    ...
    return _write_report_history(
        _summary_report_dir(summary_location),
...
def write_runtime_release_summary(summary: dict[str, Any]) -> Path | str:
    ...
    _write_report_json(summary_location, summary)
