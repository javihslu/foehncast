...
_DEFAULT_HINDCAST_INTERVAL_SECONDS = 3600
...
def get_hindcast_interval_seconds() -> int:
    """Return the configured interval, in seconds, between hindcast validation runs."""
    return _positive_int(
        get_monitoring_config().get("hindcast_interval_seconds"),
        _DEFAULT_HINDCAST_INTERVAL_SECONDS,
    )
