...
The full service-by-service mapping lives on the [Cloud Deployment](system/cloud-architecture.md) page. The local stack is the maintained path; a hosted demo is deployed from the same Terraform when one is running.
