...
| What | Where |
|------|-------|
| CI (shell, lint, terraform, dvc, compose, test, and docs jobs) | `.github/workflows/ci.yml` |
...
**Docs**: [Operator Runbook](delivery-and-operator-workflow.md)
...
| Alert rules | `prometheus_config/alerting_rules.yml` |
