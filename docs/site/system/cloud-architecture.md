...
*Status: this page is the reference architecture for the hosted environment. The Terraform under `terraform/` deploys it, and the live demo runs from exactly this configuration.*
