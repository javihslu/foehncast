...
*Status: this page is the reference architecture for the hosted environment. The Terraform under `terraform/` deploys it, and a hosted demo, when one is running, runs from exactly this configuration.*
