...
Usage:
    ...
    uv run python scripts/backfill-history.py

    # Archive data only (no predictions, no training)
    uv run python scripts/backfill-history.py --no-predictions --no-train

    # Custom date range
    uv run python scripts/backfill-history.py --start 2025-01-01 --end 2026-05-10
