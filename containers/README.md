...
See [../docs/site/system/cloud-architecture.md](../docs/site/system/cloud-architecture.md) for the hosted target contract and [../docs/site/system/delivery-and-operator-workflow.md](../docs/site/system/delivery-and-operator-workflow.md) for the bootstrap and day-2 delivery flow.
