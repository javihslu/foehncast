...
from foehncast.monitoring import prediction_log_prometheus
...
def test_render_prediction_log_prometheus_metrics_uses_model_labelled_gauges() -> None:
    ...
    payload = prediction_log_prometheus.render_prediction_log_prometheus_metrics(
...
def test_durable_metric_prefix_constant_covers_all_rendered_metric_names() -> None:
    ...
    prefix = prediction_log_prometheus.DURABLE_METRIC_PREFIX
